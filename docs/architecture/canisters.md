...
| Space World | the third world — planets in a starfield void, the same rules and money; every shop in an orbital station | `2j4oq-qiaaa-aaaap-quxuq-cai` |
| Desert World | the fourth world — dunes, three pyramids, a temple precinct and the wadi that used to be a river; five dungeons under it | `l5yya-vyaaa-aaaap-quyqq-cai` |
...
| The Item Vault | one collection for the things a character owns across every world, so a key lost in one can be asked for in another | `o2g6a-eiaaa-aaaap-quynq-cai` |
